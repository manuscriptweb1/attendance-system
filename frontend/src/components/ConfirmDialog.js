      ...
      <div className="fixed inset-0 admin-overlay backdrop-blur-sm flex items-center justify-center z-[100] p-4 animate-fade-in">
        <div className="admin-modal rounded-2xl w-full max-w-md animate-scale-in">
          ...
          <div className="admin-modal-body px-6 py-5">
            <p className="text-sm text-admin-modal-text leading-relaxed">{message}</p>
          </div>
          <div className="admin-modal-footer flex items-center justify-end gap-3 px-6 py-4 border-t">
            <button onClick={onClose} className="admin-btn-neutral px-4 py-2 text-sm font-semibold hover:text-red-500 transition-colors">
              {cancelText}
            </button>
