...
const adminSections = [
  ...
  { label: 'People',           items: [{ path: '/admin/employees', icon: FiUsers, label: 'Employees', pageKey: 'employees' }, { path: '/admin/offer-letters', icon: FiFileText, label: 'Official Letters', pageKey: 'offer_letters' }, { path: '/admin/departments', icon: FiLayers, label: 'Departments', pageKey: 'departments' }, { path: '/admin/management', icon: FiShield, label: 'Admin Management', pageKey: 'admin_management' }] },
