                    ...
                    <tr key={emp.employee_id} className={`admin-table-row ${selectedIds.includes(emp.employee_id) ? 'bg-blue-500/5' : ''}`}>
                      ...
                      <td className="px-4 py-3.5 whitespace-nowrap">
                        <div className="flex items-center gap-1.5">
                          ...
                          {emp.validation_method === 'Manual' && <span className="text-[10px] font-bold text-purple-500 bg-purple-500/10 border border-purple-500/20 px-2 py-0.5 rounded-full">Manual</span>}
                          {emp.validation_method === 'Paid Leave' && <span className="text-[10px] font-bold text-emerald-400 bg-emerald-500/15 border border-emerald-500/30 px-2 py-0.5 rounded-full">Paid Leave</span>}
                        </div>
                      </td>
                      <td className="px-4 py-3.5 text-sm text-slate-400 whitespace-nowrap">
                        {emp.absent_reason || '-'}
            ...
            <div className="px-6 py-5 overflow-y-auto dark-scroll space-y-4">
              <form id="manual-form" onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-admin-secondary uppercase tracking-wider mb-2">Check-Out Time <span className="text-slate-400 font-normal lowercase">(optional)</span></label>
